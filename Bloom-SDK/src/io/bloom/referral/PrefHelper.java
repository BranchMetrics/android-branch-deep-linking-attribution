...
public class PrefHelper {
	...
	private static final String SHARED_PREF_FILE = "bloom_referral_shared_pref";

	private static final String KEY_APP_KEY = "blm_app_key";
	
	private static final String KEY_USER_ID = "blm_user_id";
	private static final String KEY_DEVICE_ID = "blm_device_id";
	private static final String KEY_LINK_CLICK_ID = "blm_link_click_id";
	private static final String KEY_USER_URL = "blm_user_url";
	
	private static final String KEY_CREDIT_BASE = "blm_credit_base_";
	private static final String KEY_TOTAL_BASE = "blm_total_base_";
	private static final String KEY_BALANCE_BASE = "blm_balance_base_";
	...
	public void setAppKey(String key) {
		...
		setString(KEY_APP_KEY, new String(encodedArray));
	}
