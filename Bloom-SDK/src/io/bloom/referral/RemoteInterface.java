...
public class RemoteInterface {
	...
	public JSONObject make_restful_get(String url, String tag, String authToken) {
		try {    	
	...
	public JSONObject make_restful_post(JSONObject body, String url, String tag, String authToken) {
		try {    	
