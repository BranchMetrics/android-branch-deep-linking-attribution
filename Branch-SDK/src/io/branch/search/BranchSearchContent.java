...
public class BranchSearchContent implements Parcelable {
    ...
    private static final String RESULT_PRIORITY_KEY = "result_priority";
    ...
    public boolean searchInApp(String keyword) {
        boolean isServiceConnected = false;
        BranchSearchServiceConnection branchSearchServiceConnection = BranchSearchServiceConnection.getInstance();
        if (branchSearchServiceConnection != null) {
            isServiceConnected = branchSearchServiceConnection.searchAppForContents(packageName_, keyword);
        }
