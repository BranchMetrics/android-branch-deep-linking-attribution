...
public class RemoteInterface {
	...
	public ServerResponse make_restful_get(String url, String tag) {
		return make_restful_get(url, tag, true);
	}
	public ServerResponse make_restful_get(String url, String tag, boolean log) {
		try {    	
			if (url.indexOf('?') == -1) {
	...
	public ServerResponse make_restful_post(JSONObject body, String url, String tag) {
		return make_restful_post(body, url, tag, true);
	}
	public ServerResponse make_restful_post(JSONObject body, String url, String tag, boolean log) {
		try {    	
