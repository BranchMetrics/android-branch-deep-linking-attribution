            ...
            public void run() {
                ...
                try {
                    ...
                    qrCode.getQRCodeAsData(getTestContext(), buo, lp, new BranchQRCode.BranchQRCodeDataHandler() {
                        ...
                        public void onSuccess(byte[] qrCodeData) {
                            try {
                                JSONObject expectedCachedParams = new JSONObject("{\"feature\":\"Share\",\"stage\":\"\",\"data\":{\"$publicly_indexable\":true,\"$locally_indexable\":true},\"channel\":\"\",\"qr_code_settings\":{\"image_format\":\"PNG\"},\"campaign\":\"\",\"branch_key\":\"key_test_hdcBLUy1xZ1JD0tKg7qrLcgirFmPPVJc\",\"tags\":[]}");
